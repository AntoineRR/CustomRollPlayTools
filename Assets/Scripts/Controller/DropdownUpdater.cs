...
public class DropdownUpdater : MonoBehaviour
{
    ...
    [Header("Fight")]
    public Dropdown attaquantDropdown;
    ...
    public void FillCharacterDropdowns()
    {
        ...
        attaquantDropdown.ClearOptions();
        attaquantDropdown.AddOptions(options);
        UpdateAttaquant();
    ...
    {
        FightController.instance.attaquant = CharacterParametersController.instance.characters[attaquantDropdown.value].saveCharacter;
