...
public class CharacterParametersController : MonoBehaviour
{
    ...
    {
        ColorPickerWindow.instance.gameObject.SetActive(true);

        ColorPickerWindow.instance.colorPicker.CurrentColor = colorButton.colors.normalColor;
        ColorPickerWindow.instance.target = colorButton;
    }
}
